...
class MY_Model extends CI_Model {
  ...
  * @return array
  */
  function GetAll($sort, $order = null) {
    if($order != null){
  ...
  /**
  * Lista todos os registros da tabela
  *Em ordem para um Select
  * 
  */
  function GetListagem() {
    
    $dados = $this->GetAll("id");
    ...
    foreach($dados as $key => $array){
        ...
        $dadosListagem[$campoPrimary] = $campoSecundary;
    }
  ...
  * @return boolean
  */
  function Atualizar($id, $campo, $data) {
